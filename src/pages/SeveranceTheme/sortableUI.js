...
const SortableItemUI = props => {
  ...
  return <div ref={forwardRef} {...attributes} style={{ ...getBaseItemStyle(isActive),
    ...style
...
function SortableUI() {
  ...
  return <div className="container-fluid">
      ...
      <Sortable idField={'id'} disabledField={'disabled'} data={data} itemUI={SortableItemUI} onDragOver={onDragOver} onNavigate={onNavigate} />
    </div>;
};
